      ...
      <div className="flex-1 overflow-y-auto">
        <main className="cart-scale flex-1 ml-60 pt-12 max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex justify-between items-center">
            <div>
              <h1 className="text-[22px] font-bold text-gray-900">Profile Settings</h1>
            ...
            {!isEditing ? (
              <button
                ...
                className="bg-[#7A1CA9] text-white px-4 py-2 rounded-lg hover:bg-[#7A1CA9]/90 transition font-medium text-sm"
              >
                Edit Profile
              </button>
            ) : (
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 transition font-medium text-sm"
                >
                  Cancel
                </button>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      disabled={!isEditing}
                      className={`w-full px-3 py-2.5 border rounded-lg text-sm ${isEditing ? 'border-gray-300 focus:ring-2 focus:ring-[#7A1CA9]' : 'bg-gray-50 border-gray-200'
                        }`}
                    />
                  </div>
                  <div>
