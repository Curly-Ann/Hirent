    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-100">
            ...
            >
                ...
                <div className="z-10 bg-white w-100 md:w-[350px] lg:w-[420px] h-[510px] rounded-lg shadow-lg p-10 flex flex-col justify-center hover:shadow-2xl hover:scale-105 transition-all duration-300">
