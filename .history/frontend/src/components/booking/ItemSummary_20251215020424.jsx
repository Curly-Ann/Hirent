      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 ml-4">
          ...
          {product.owner && (
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="text-sm text-gray-600">
                <span className="text-gray-600 mb-2">Listed by</span>
                <br />
                <span className="font-medium text-purple-900 ">{product.owner.name}</span>
              </div>
            </div>
          )}
          ...
          <div className="flex items-center justify-start border-b">
            ...
            {product.location && (
              <div className="flex items-center gap-1 ml-5 text-gray-900 text-sm">
                <MapPin className="w-4 h-4" />
                {product.zone}, {product.location}, {product.province}
              </div>
            )}
          </div>
